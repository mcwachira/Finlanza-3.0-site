...
<title>Get In Touch — Book a Free Consultation | Finlanza</title>
<!-- SEO: Added meta description -->
<meta name="description" content="Contact Finlanza for a free 45-minute consultation about your business systems. We're a Business Systems Architecture Firm in Nairobi, Kenya serving African businesses. No commitment, no pitch deck.">
<!-- SEO: Added canonical URL -->
<link rel="canonical" href="https://finlanza.com/contact.html">
<!-- SEO: Added Open Graph tags -->
<meta property="og:title" content="Get In Touch — Book a Free Consultation | Finlanza">
<meta property="og:description" content="Contact Finlanza for a free 45-minute consultation about your business systems. We're a Business Systems Architecture Firm in Nairobi, Kenya serving African businesses.">
<meta property="og:image" content="https://finlanza.com/images/finlanza-contact-og.jpg">
<meta property="og:url" content="https://finlanza.com/contact.html">
<meta property="og:type" content="website">
<!-- SEO: Added Twitter Card tags -->
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:title" content="Get In Touch — Book a Free Consultation | Finlanza">
<meta name="twitter:description" content="Contact Finlanza for a free 45-minute consultation about your business systems. We're a Business Systems Architecture Firm in Nairobi, Kenya.">
<meta name="twitter:image" content="https://finlanza.com/images/finlanza-contact-twitter.jpg">
<!-- SEO: Added structured data -->
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ContactPage",
  "name": "Contact Finlanza",
  "description": "Contact Finlanza for a free 45-minute consultation about your business systems. We're a Business Systems Architecture Firm in Nairobi, Kenya serving African businesses.",
  "url": "https://finlanza.com/contact.html",
  "mainEntity": {
    "@type": "LocalBusiness",
    "name": "Finlanza",
    "description": "Business Systems Architecture Firm",
    "telephone": "+254724463536",
    "email": "ask@finlanza.com",
...
.contact-left { 
  padding: 64px 64px 64px 0;   /* was 64px 56px */
  border-right: 1px solid var(--border); 
}
  ...
  align-items: flex-start; 
  gap: 20px; 
  padding: 28px 0;          /* was 20px — more vertical breathing room */
  border-bottom: 1px solid var(--border-light); 
  }
  .contact-info-icon {
 width: 48px;              /* was 40px */
  height: 48px;             /* was 40px */
  background: rgba(200,151,28,0.08); 
  border: 1px solid var(--border); 
  display: flex; 
  align-items: center; 
  justify-content: center; 
...
/* Accessibility: Added screen reader utility class */
.sr-only {
  position: absolute;
  width: 1px;
  height: 1px;
...
@media (prefers-reduced-motion: reduce) {
  ...
  .contact-grid { display:grid; grid-template-columns:1fr 1.1fr; gap:0; min-height:70vh; }
  .contact-left { padding:64px 56px 64px 0; border-right:1px solid var(--border); }
  .contact-right { padding:64px 0 64px 56px; }
  .contact-info-item { display:flex; align-items:flex-start; gap:16px; padding:20px 0; border-bottom:1px solid var(--border-light); }
  .contact-info-icon { width:40px; height:40px; background:rgba(200,151,28,0.08); border:1px solid var(--border); display:flex; align-items:center; justify-content:center; font-size:18px; flex-shrink:0; }
  .contact-info-label { font-size:11px; letter-spacing:1.5px; text-transform:uppercase; color:var(--gold); margin-bottom:4px; }
  .contact-info-val { font-size:15px; color:var(--text); line-height:1.5; }
  .contact-info-val a { color:var(--text); text-decoration:none; }
  .form-group { margin-bottom:18px; }
  .form-label { display:block; font-size:11px; letter-spacing:1.2px; text-transform:uppercase; color:var(--gold); margin-bottom:6px; }
  .form-input,.form-select,.form-textarea { width:100%; background:var(--navy-mid); border:1px solid var(--border); color:var(--text); padding:12px 16px; font-family:'DM Sans',sans-serif; font-size:15px; font-weight:300; outline:none; transition:border-color 0.2s; }
  .form-input:focus,.form-select:focus,.form-textarea:focus { border-color:var(--gold); }
  .form-input::placeholder,.form-textarea::placeholder { color:var(--text-muted); }
  .form-select option { background:var(--navy-mid); }
  .form-textarea { min-height:120px; resize:vertical; }
  .form-row-2 { display:grid; grid-template-columns:1fr 1fr; gap:14px; }
  @media(max-width:900px){ .contact-grid{grid-template-columns:1fr;} .contact-left{border-right:none;border-bottom:1px solid var(--border);padding:40px 0;} .contact-right{padding:40px 0;} .form-row-2{grid-template-columns:1fr;} }
...
<body>
  ...
  <!-- Accessibility: Updated hamburger button with proper ARIA -->
...
<section class="page-hero" style="padding-bottom:0;">
  ...
  <div class="container" style="position:relative;z-index:2;padding-top:100px;padding-bottom:48px;">
    <span class="label reveal">Get In Touch</span>
    <!-- SEO: Wrapped hero heading in proper h1 -->
    <h1 class="display-lg reveal reveal-d1">LET'S TALK ABOUT<br>YOUR <span class="gold">BUSINESS.</span></h1>
  </div>
</section>

<section class="section" style="padding-top:0;">
  <div class="container">
    <div style="background:var(--navy-mid);border:1px solid var(--border);border-top:3px solid var(--gold);padding:28px 36px;margin-bottom:48px;display:grid;grid-template-columns:1fr 1fr;gap:40px;align-items:center;" class="reveal">
      <div>
        <span class="label">How We Work</span>
        <div style="font-family:'DM Serif Display',serif;font-size:24px;color:var(--white);margin:8px 0;line-height:1.3;">The first call is free.</div>
        <p style="color:var(--text-muted);font-size:14px;line-height:1.8;">A 45-minute conversation with a Finlanza consultant. We'll listen to what you're dealing with, ask the questions that matter, and tell you honestly whether we're the right fit — and what we'd recommend.</p>
      </div>
      <div style="display:flex;flex-direction:column;gap:10px;font-size:14px;color:var(--text-muted);">
        <!-- Accessibility: Added screen reader support for checkmarks -->
        <div><span aria-hidden="true">✓</span> <span class="sr-only">No pitch deck. No proposal.</span> &nbsp;No pitch deck. No proposal.</div>
        <div><span aria-hidden="true">✓</span> <span class="sr-only">No cost. No commitment.</span> &nbsp;No cost. No commitment.</div>
        <div><span aria-hidden="true">✓</span> <span class="sr-only">Just an honest conversation about your business.</span> &nbsp;Just an honest conversation about your business.</div>
        <div><span aria-hidden="true">✓</span> <span class="sr-only">We'll tell you what you need — even if that's not us.</span> &nbsp;We'll tell you what you need — even if that's not us.</div>
      </div>
    </div>

    <div class="contact-grid">
      <div class="contact-left reveal">
        <!-- Accessibility: Added proper h2 for section heading -->
        <h2 class="label" style="display:block;margin-bottom:20px;">Direct Contact</h2>
        <div class="contact-info-item">
          <div class="contact-info-icon">📧</div>
          <div><div class="contact-info-label">Email</div><div class="contact-info-val"><a href="mailto:ask@finlanza.com" aria-label="Email Finlanza at ask@finlanza.com">ask@finlanza.com</a></div></div>
        </div>
        <div class="contact-info-item">
          <div class="contact-info-icon">📞</div>
          <div><div class="contact-info-label">Phone / WhatsApp</div><div class="contact-info-val"><a href="tel:+254724463536" aria-label="Call or WhatsApp Finlanza at +254 724 463 536">+254 724 463 536</a></div></div>
        </div>
        <div class="contact-info-item">
          <div class="contact-info-icon">📍</div>
          <div><div class="contact-info-label">Primary Office</div><div class="contact-info-val">Nairobi, Kenya<br><span style="color:var(--text-muted);font-size:13px;">Serving all African markets remotely and on-site</span></div></div>
        </div>
        <div class="contact-info-item" style="border-bottom:none;">
          <div class="contact-info-icon">🕐</div>
          <div><div class="contact-info-label">Response Time</div><div class="contact-info-val">Within 1 business day</div></div>
        </div>
        <div style="margin-top:32px;padding:20px;background:rgba(200,151,28,0.05);border:1px solid var(--border);">
          <div class="label" style="margin-bottom:8px;">Not ready for a call?</div>
          <p style="font-size:13px;color:var(--text-muted);line-height:1.7;margin-bottom:14px;">Take the 18-question Business Systems Health Check. You'll get a scored assessment of your operational gaps — and a clear sense of which engagement is right for you.</p>
          <a href="https://finlanza.com/scorecard.html" class="btn-ghost" style="display:block;text-align:center;font-size:12px;">Take the Free Scorecard →</a>
        </div>
      </div>

      <div class="contact-right reveal reveal-d2">
        <!-- Accessibility: Added proper h2 for section heading -->
        <h2 class="label" style="display:block;margin-bottom:20px;">Send A Message</h2>
        <div class="form-row-2">
          <div class="form-group"><label class="form-label" for="firstName">First Name</label><input class="form-input" type="text" id="firstName" placeholder="Amara" autocomplete="given-name" aria-required="true"></div>
          <div class="form-group"><label class="form-label" for="lastName">Last Name</label><input class="form-input" type="text" id="lastName" placeholder="Osei" autocomplete="family-name" aria-required="true"></div>
        </div>
        <div class="form-group"><label class="form-label" for="organisation">Organisation</label><input class="form-input" type="text" id="organisation" placeholder="Company name" autocomplete="organization"></div>
        <div class="form-group"><label class="form-label" for="email">Work Email</label><input class="form-input" type="email" id="email" placeholder="your@email.com" autocomplete="email" aria-required="true"></div>
        <div class="form-row-2">
          <div class="form-group"><label class="form-label" for="country">Country</label><input class="form-input" type="text" id="country" placeholder="Kenya, Zambia..." autocomplete="country-name"></div>
          <div class="form-group"><label class="form-label" for="enquiryType">What Are You Looking For?</label>
            <select class="form-select" id="enquiryType">
              <option value="">Select...</option>
              <option>Diagnose engagement</option>
              <option>Full Transform engagement</option>
              <option>Managed retainer</option>
              <option>Just a conversation</option>
              <option>Not sure yet</option>
            </select>
          </div>
        </div>
        <div class="form-group"><label class="form-label" for="message">Tell Us About Your Business</label><textarea class="form-textarea" id="message" placeholder="What does your business do? How big is it? What's the main challenge you're trying to solve?" aria-required="true"></textarea></div>
        <!-- Accessibility: Added proper button attributes -->
        <button class="btn-primary" style="width:100%;text-align:center;" id="submitBtn" type="button" onclick="handleSubmit(this)" aria-busy="false">Send Message →</button>
        <p style="color:var(--text-muted);font-size:13px;margin-top:14px;text-align:center;">We'll respond within 1 business day. No spam, no pitch deck, no pressure.</p>
      </div>
    </div>
  </div>
</section>
...
function handleSubmit(btn) {
  ...
  // Accessibility: Set aria-busy during sending
