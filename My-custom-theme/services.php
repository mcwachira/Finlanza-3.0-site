...
<title>Our Services — Finlanza</title>
...
<style>
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .service-card-v2 { background:var(--navy-mid); border:1px solid var(--border); padding:40px 36px; position:relative; }
  .service-card-v2.featured { border-color:var(--gold); }
  .service-card-v2.featured::before { content:'Most Popular'; position:absolute; top:-1px; left:50%; transform:translateX(-50%); background:var(--gold); color:var(--navy); font-size:10px; letter-spacing:1.5px; text-transform:uppercase; padding:4px 16px; white-space:nowrap; }
...
<section class="page-hero">
  ...
  <div class="container" style="position:relative;z-index:2;padding-top:100px;padding-bottom:60px;">
    ...
    <div class="display-lg reveal reveal-d1">THREE WAYS TO<br>WORK WITH US.</div>
...
<section class="section">
  <div class="container">
    <div class="grid-3" style="gap:2px;background:var(--border);align-items:start;">
      ...
      <div class="service-card-v2 reveal">
        ...
        <a href="<?php echo home_url('/contact/'); ?>" class="btn-ghost">Book a Scoping Call →</a>
      </div>
      ...
      <div class="service-card-v2 featured reveal reveal-d1">
        ...
        <a href="<?php echo home_url('/contact/'); ?>" class="btn-primary">Book a Call →</a>
      </div>
  ...
  <div class="container">
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:60px;align-items:center;">
      <div class="reveal">
        ...
        <a href="scorecard.html" class="btn-primary">Take the Free Scorecard →</a>
      </div>
      <div class="reveal reveal-d2" style="background:var(--navy-mid);border:1px solid var(--border);padding:40px;">
        ...
        <a href="<?php echo home_url('/contact/'); ?>" class="btn-ghost" style="display:block;text-align:center;">Book a 45-Minute Discovery Call →</a>
...
<footer>
  ...
  <a href="<?php echo home_url('/services/'); ?>" style="color:var(--text-muted);font-size:13px;text-decoration:none;">Diagnose Services</a>
      ...
      <div>
        ...
        <div style="display:flex;flex-direction:column;gap:9px;">
         <a href="<?php echo home_url('/garage-erp/'); ?>"> style="color:var(--text-muted);font-size:13px;text-decoration:none;" aria-label="View GarageERP product page">GarageERP</a>
          <a href="<?php echo home_url('/poultry-os/'); ?>"> style="color:var(--text-muted);font-size:13px;text-decoration:none;" aria-label="View PoultryOS product page">PoultryOS</a>
          <a  href="<?php echo home_url('/products/'); ?>"> style="color:var(--text-muted);font-size:13px;text-decoration:none;" aria-label="View all Finlanza products">Full Suite </a>
    ...
    <div style="display:flex;justify-content:space-between;align-items:center;padding:20px 0;flex-wrap:wrap;gap:12px;">
      ...
      <div style="display:flex;gap:20px;align-items:center;">
        <a href="/cdn-cgi/l/email-protection#87e4e8ebebeee9f4c7e1eee9ebe6e9fde6a9e4e8ea" style="color:var(--text-muted);font-size:12px;text-decoration:none;"><span class="__cf_email__" data-cfemail="caa9a5a6a6a3a4b98aaca3a4a6aba4b0abe4a9a5a7">[email&#160;protected]</span></a>
        <a href="<?php echo home_url('/privacy-policy/'); ?>" style="color:var(--text-muted);font-size:12px;text-decoration:none;">Privacy Policy</a>
