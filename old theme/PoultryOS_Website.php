<?php
/* Template Name: Finlanza Poultry OS */
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<meta name="description" content="Poultry OS is a complete production management and profitability system for commercial poultry farms built on Zoho Creator by Finlanza. Track every batch, every bird, every shilling — from chick arrival to slaughter. Now accepting pilot clients in East Africa.">
...
<meta property="og:description" content="Complete production management and profitability system for commercial poultry farms. Track every batch, every bird, every shilling.">
...
<meta name="twitter:description" content="Complete production management system for commercial poultry farms. Now accepting pilot clients.">
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "SoftwareApplication",
  "name": "Finlanza Poultry OS",
  "description": "A complete production management and profitability system for commercial poultry farms, built on Zoho Creator. Tracks batches, feed conversion ratio, mortality, and cost per bird.",
...
<style>
  :root{
    ...
    --mid:#374151;--green:#16A34A;--amber:#D97706;--red:#DC2626;--teal:#0E7490;
  }
  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
  ...
  @media(max-width:900px){
    ...
    .revenue-box{flex-direction:column;gap:1.5rem;}
...
<section class="hero" id="top">
  <div class="hero-left">
    <div class="hero-eyebrow"><span aria-hidden="true"></span> F2 Transform — Agri-Tech Vertical</div>
...
<section id="modules">
  ...
  <div class="module-grid">
    <div class="module-card"><div class="module-icon" aria-hidden="true">🐥</div><div class="module-name">Batch Management</div><div class="module-desc">Create and track batches from chick purchase to close. Each batch has a unique ID, house assignment, chick source, and expected slaughter date.</div></div>
    <div class="module-card"><div class="module-icon" aria-hidden="true">📋</div><div class="module-name">Daily Production Log</div><div class="module-desc">Daily record of live bird count, average body weight, FCR update, feed consumption, and water usage. Core operational input — takes under 3 minutes per day.</div></div>
    <div class="module-card"><div class="module-icon" aria-hidden="true">⚖️</div><div class="module-name">Feed &amp; Medicine Tracking</div><div class="module-desc">Feed and medicine issues recorded against each batch. Cost automatically posted to batch cost centre in Zoho Books. Running feed cost and FCR always current.</div></div>
    <div class="module-card"><div class="module-icon" aria-hidden="true">💀</div><div class="module-name">Mortality Log</div><div class="module-desc">Individual mortality entries with cause classification. Single source of truth. Cumulative mortality rate calculated and compared against batch benchmark.</div></div>
    <div class="module-card"><div class="module-icon" aria-hidden="true">🔬</div><div class="module-name">Vaccination &amp; Treatment</div><div class="module-desc">Vaccination schedule and treatment records per batch. Product, dosage, withdrawal period, and administering staff recorded. Required for farms supplying regulated buyers.</div></div>
    <div class="module-card"><div class="module-icon" aria-hidden="true">📏</div><div class="module-name">Weighing &amp; Sampling</div><div class="module-desc">Periodic weight sampling events. Sample weight data feeds FCR calculation and slaughter date forecasting. Logged by farm supervisor at each weighing event.</div></div>
    <div class="module-card"><div class="module-icon" aria-hidden="true">🔪</div><div class="module-name">Slaughter &amp; Packing</div><div class="module-desc">Slaughter event records birds processed, weight classes, and packing output. Automatically triggers inventory conversion and barcode label generation.</div></div>
    <div class="module-card"><div class="module-icon" aria-hidden="true">🏷️</div><div class="module-name">Barcode Traceability</div><div class="module-desc">Every packing unit gets a unique barcode linking back to the originating batch. Format configurable per client. GS1 compliance available in V2.<span class="v2-badge">V2</span></div></div>
    <div class="module-card"><div class="module-icon" aria-hidden="true">📊</div><div class="module-name">Batch Cost Analysis</div><div class="module-desc">Full cost rollup at batch close: chick cost, feed cost, medicine cost, labour, overhead. Cost per bird and profit per bird calculated and stored permanently.</div></div>
  </div>
</section>
...
<section class="lifecycle" id="lifecycle">
  ...
  <div class="lifecycle-flow">
    <div class="lf-step">Chick Purchase</div><div class="lf-arrow" aria-hidden="true">→</div>
    <div class="lf-step">Batch Creation</div><div class="lf-arrow" aria-hidden="true">→</div>
    <div class="lf-step">Daily Production Logs</div><div class="lf-arrow" aria-hidden="true">→</div>
    <div class="lf-step">Feed &amp; Medicine Issues</div><div class="lf-arrow" aria-hidden="true">→</div>
    <div class="lf-step">Mortality Recording</div><div class="lf-arrow" aria-hidden="true">→</div>
    <div class="lf-step">Vaccination &amp; Treatment</div><div class="lf-arrow" aria-hidden="true">→</div>
    <div class="lf-step">Weighing &amp; Sampling</div><div class="lf-arrow" aria-hidden="true">→</div>
    <div class="lf-step">Slaughter &amp; Packing</div><div class="lf-arrow" aria-hidden="true">→</div>
    <div class="lf-step">Barcode Labelling</div><div class="lf-arrow" aria-hidden="true">→</div>
    <div class="lf-step">Sales &amp; Dispatch</div><div class="lf-arrow" aria-hidden="true">→</div>
