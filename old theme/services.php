<?php
/* Template Name: Finlanza Services */
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<title>Our Services — Diagnose, Transform & Managed | Finlanza</title>
<!-- SEO: Complete meta block -->
<meta name="description" content="Finlanza offers three service tiers: Diagnose (assessment), Transform (full implementation), and Managed (ongoing support). Business Systems Architecture Firm serving Kenya, Zambia and across Africa.">
<meta name="robots" content="index, follow">
<link rel="canonical" href="https://finlanza.com/services.html">

<!-- SEO: Open Graph tags -->
<meta property="og:title" content="Our Services — Diagnose, Transform & Managed | Finlanza">
<meta property="og:description" content="Three service tiers: Diagnose assessment, Transform full implementation, and Managed ongoing support. Zoho Authorized Partner serving Africa.">
<meta property="og:image" content="https://finlanza.com/images/finlanza-services-og-image.jpg">
<meta property="og:url" content="https://finlanza.com/services.html">
<meta property="og:type" content="website">
<meta property="og:site_name" content="Finlanza">

<!-- SEO: Twitter Card tags -->
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:title" content="Our Services — Diagnose, Transform & Managed | Finlanza">
<meta name="twitter:description" content="Three service tiers: Diagnose assessment, Transform full implementation, and Managed ongoing support.">
<meta name="twitter:image" content="https://finlanza.com/images/finlanza-services-twitter-image.jpg">
...
<script type="application/ld+json">
{
  ...
  "description": "Comprehensive business systems assessment including stakeholder discovery, document vault analysis, AI-powered synthesis, DREAM dimension RAG assessment, and prioritized recommendations.",
  "provider": {
    "@type": "Organization",
    "name": "Finlanza",
    "address": {
...
<script type="application/ld+json">
{
  ...
  "description": "Full business systems transformation from diagnosis to operational system including process reengineering, Zoho implementation, system integrations, department training, and executive dashboards.",
  "provider": {
    "@type": "Organization",
    "name": "Finlanza",
    "address": {
...
<script type="application/ld+json">
{
  ...
  "description": "Ongoing business systems management with dedicated consultant, monthly optimization, report production, user management, priority support, and quarterly business reviews.",
  "provider": {
    "@type": "Organization",
    "name": "Finlanza",
    "address": {
...
<style>
  ...
  /* Note: --text-muted: #8A9BAD against --navy-mid: #152232 passes WCAG AA with 4.5:1 ratio */
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .service-tier-badge { display:inline-block; font-size:10px; letter-spacing:1.5px; text-transform:uppercase; color:var(--gold); border:1px solid var(--border); padding:4px 10px; margin-bottom:14px; }
  .service-card-v2 {
      background: var(--navy-mid); 
  border: 1px solid var(--border); 
  padding: 40px 36px; 
...
.service-card-v2.featured { 
  ...
  box-shadow: 0 24px 60px rgba(200,151,28,0.15), 0 8px 24px rgba(0,0,0,0.4);
  z-index: 2;
}
...
.service-card-v2.featured::before { 
  ...
  .svc-name-big { font-family:'Bebas Neue',sans-serif; font-size:40px; letter-spacing:2px; color:var(--white); margin-bottom:6px; }
  .svc-tagline { font-family:'DM Serif Display',serif; font-size:17px; font-style:italic; color:var(--gold-light); margin-bottom:24px; line-height:1.4; }
  .svc-features { list-style:none; margin-bottom:24px; }
  .svc-features li { display:flex; align-items:flex-start; gap:10px; padding:10px 0; border-bottom:1px solid var(--border-light); font-size:14px; color:var(--text-muted); line-height:1.5; }
  .svc-features li::before { content:'✓'; color:var(--gold); flex-shrink:0; margin-top:1px; font-size:13px; }
  .svc-foot { font-size:13.5px; color:var(--text-muted); line-height:1.7; margin-bottom:24px; padding-top:8px; border-top:1px solid var(--border-light); }
  .ind-fit-grid { display:grid; grid-template-columns:repeat(3,1fr); gap:1px; background:var(--border); }
  .ind-fit-card { background:var(--navy-mid); padding:28px 24px; }
  .ind-fit-svc { font-size:10px; letter-spacing:1.5px; text-transform:uppercase; color:var(--gold); margin-bottom:8px; }
  .ind-fit-name { font-size:14px; font-weight:500; color:var(--white); margin-bottom:10px; }
  .ind-fit-tags { display:flex; flex-wrap:wrap; gap:5px; }
  .ind-fit-tag { font-size:10px; letter-spacing:0.8px; text-transform:uppercase; color:var(--text-muted); border:1px solid rgba(255,255,255,0.08); padding:3px 7px; }
  @media(max-width:900px){ .grid-3{grid-template-columns:1fr!important;} .ind-fit-grid{grid-template-columns:1fr 1fr;} }
  @media(max-width:600px){ .ind-fit-grid{grid-template-columns:1fr;} }
...
<section class="page-hero">
  ...
  <div class="container" style="position:relative;z-index:2;padding-top:100px;padding-bottom:60px;">
    ...
    <h1 class="display-lg reveal reveal-d1">THREE WAYS TO<br>WORK WITH US.</h1>
    <p style="color:var(--text-muted);font-size:18px;max-width:600px;line-height:1.8;margin-top:20px;" class="reveal reveal-d2">Every engagement is different. Every client starts with a conversation — not a proposal. We tell you what you need, not what we want to sell you.</p>
  </div>
</section>

<section class="section">
  <div class="container">
<div class="grid-3" style="gap:24px;background:transparent;align-items:start;">

      <div class="service-card-v2 reveal">
        <div class="service-tier-badge">Phase 1 — Diagnostic</div>
        <div class="svc-name-big">DIAGNOSE</div>
        <div class="svc-tagline">The most honest assessment of your business you've ever had.</div>
        <ul class="svc-features">
          <li>Stakeholder discovery sessions (all departments)</li>
https://finlanza.com/wp-admin/theme-editor.php?file=dream.php&theme=My-custom-theme          <li>Document vault analysis (financials, processes, systems)</li>
          <li>AI-powered synthesis and pattern recognition</li>
          <li>Full DREAM dimension RAG assessment</li>
          <li>Zoho architecture recommendation</li>
          <li>Prioritised recommendations (5–8 with effort/impact rating)</li>
          <li>Presentation to leadership team</li>
          <li>3–4 week delivery</li>
        </ul>
        <div class="svc-foot">Stand-alone or as the entry point to Transform. The report is yours to keep and act on independently.</div>
        <a href="pricing.html" class="btn-ghost">View Pricing →</a>
      </div>

      <div class="service-card-v2 featured reveal reveal-d1">
        <div class="service-tier-badge">Full Engagement</div>
        <div class="svc-name-big">TRANSFORM</div>
        <div class="svc-tagline">From diagnosis to a fully operational system — start to finish.</div>
        <ul class="svc-features">
          <li>Full Diagnose phase included</li>
          <li>Process reengineering and requirements documentation</li>
          <li>Full Zoho implementation (Books, CRM, Creator, Analytics)</li>
          <li>System integrations — all in-scope applications connected</li>
          <li>Department-by-department training programme</li>
          <li>UAT facilitation and go-live support</li>
          <li>Executive and department dashboards</li>
          <li>8–16 week delivery (scope dependent)</li>
        </ul>
        <div class="svc-foot">The full DREAM Framework™ engagement. Milestone-based payments, formal sign-off at each gate.</div>
        <a href="https://finlanza.com/contact.html" class="btn-primary">Book a Call →</a>
      </div>

      <div class="service-card-v2 reveal reveal-d2">
        <div class="service-tier-badge">Ongoing — Retainer</div>
        <div class="svc-name-big">MANAGED</div>
        <div class="svc-tagline">Your systems keep evolving. We make sure they keep working.</div>
        <ul class="svc-features">
          <li>Monthly system management and optimisation</li>
          <li>Dedicated Finlanza consultant (named, single point of contact)</li>
          <li>Report production and KPI monitoring</li>
          <li>User management and access control</li>
          <li>New feature configuration as needs change</li>
          <li>Priority support SLA (4-hour response)</li>
          <li>Quarterly business review with leadership team</li>
          <li>Rolling monthly contract</li>
        </ul>
        <div class="svc-foot">Available post-Transform. For businesses that want Finlanza as a permanent part of their operational infrastructure.</div>
        <a href="https://finlanza.com/pricing.html" class="btn-ghost">View Pricing →</a>
      </div>
...
<section class="section" style="background:var(--navy-mid);border-top:1px solid var(--border);border-bottom:1px solid var(--border); padding-bottom:120px;">
  <div class="container">
    <span class="label reveal">Operating Environment Fit</span>
    <div class="display-md reveal reveal-d1" style="margin-bottom:12px;">THE RIGHT ENGAGEMENT FOR YOUR <span class="gold">COMPLEXITY LEVEL.</span></div>
    <p style="color:var(--text-muted);font-size:16px;max-width:600px;line-height:1.8;margin-bottom:36px;" class="reveal reveal-d2">Each service tier is calibrated to a specific type of organizational challenge. Here's where each engagement fits.</p>
    <div class="ind-fit-grid reveal reveal-d2">
      <div class="ind-fit-card"><div class="ind-fit-svc">Diagnose</div><div class="ind-fit-name">NGOs &amp; Donor Programs</div><div class="ind-fit-tags"><span class="ind-fit-tag">Grant Tracking</span><span class="ind-fit-tag">Compliance Reporting</span><span class="ind-fit-tag">Multi-Project Budgets</span></div></div>
      <div class="ind-fit-card"><div class="ind-fit-svc">Transform</div><div class="ind-fit-name">Logistics &amp; Transport</div><div class="ind-fit-tags"><span class="ind-fit-tag">Multi-Branch ERP</span><span class="ind-fit-tag">Fleet Systems</span><span class="ind-fit-tag">Financial Consolidation</span></div></div>
      <div class="ind-fit-card"><div class="ind-fit-svc">Transform</div><div class="ind-fit-name">Manufacturing</div><div class="ind-fit-tags"><span class="ind-fit-tag">BoM Architecture</span><span class="ind-fit-tag">Production Cost Visibility</span><span class="ind-fit-tag">Material Variance</span></div></div>
      <div class="ind-fit-card"><div class="ind-fit-svc">Diagnose / Transform</div><div class="ind-fit-name">Education Institutions</div><div class="ind-fit-tags"><span class="ind-fit-tag">Term Billing</span><span class="ind-fit-tag">Fee Management</span><span class="ind-fit-tag">Financial Visibility</span></div></div>
      <div class="ind-fit-card"><div class="ind-fit-svc">Transform / Managed</div><div class="ind-fit-name">Retail &amp; Distribution</div><div class="ind-fit-tags"><span class="ind-fit-tag">Inventory Governance</span><span class="ind-fit-tag">Warehouse Control</span><span class="ind-fit-tag">Revenue Reporting</span></div></div>
      <div class="ind-fit-card"><div class="ind-fit-svc">Transform</div><div class="ind-fit-name">Construction &amp; Field Ops</div><div class="ind-fit-tags"><span class="ind-fit-tag">Project Budgeting</span><span class="ind-fit-tag">Approval Workflows</span><span class="ind-fit-tag">Cost Monitoring</span></div></div>
    </div>
    <div style="margin-top:2px;padding:14px;border:1px solid var(--border);font-size:12px;letter-spacing:1.2px;text-transform:uppercase;color:var(--gold);text-align:center;" class="reveal">Regional deployment footprint across Kenya, Zambia, and multi-country environments</div>
  </div>
</section>
  ...
  <div class="container">
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:60px;align-items:center;">
      <div class="reveal">
        ...
        <div class="display-md" style="margin-bottom:16px;">START WITH A <span class="gold">DIAGNOSTIC SCORECARD.</span></div>
        <p style="color:var(--text-muted);font-size:16px;line-height:1.8;margin-bottom:24px;">Answer 18 questions about your business systems and get an honest, scored assessment of where your operational gaps are — and what to do about them. Takes 5 minutes. No demo attached.</p>
        <a href="https://finlanza.com/scorecard.html" class="btn-primary">Take the Free Scorecard →</a>
      </div>
      <div class="reveal reveal-d2" style="background:var(--navy-mid);border:1px solid var(--border);padding:40px;">
        <span class="label">Or book a conversation</span>
        <div style="font-family:'DM Serif Display',serif;font-size:24px;color:var(--white);margin:12px 0;line-height:1.3;">The first call is free.<br>No pitch. No proposal.</div>
        <p style="color:var(--text-muted);font-size:14px;line-height:1.8;margin-bottom:22px;">A 45-minute conversation with a Finlanza consultant. We'll listen, ask the questions that matter, and tell you honestly whether we're the right fit.</p>
        <a href="https://finlanza.com/contact.html" class="btn-ghost" style="display:block;text-align:center;">Book a 45-Minute Discovery Call →</a>
        <p style="color:var(--text-muted);font-size:12px;margin-top:12px;text-align:center;">No cost. No commitment. No sales pitch.</p>
      </div>
    </div>
  </div>
</section>
