...
<style>
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .stat-strip { background:var(--navy-mid); border-top:1px solid var(--border); border-bottom:1px solid var(--border); padding:0; }
  ...
  .infra-card { background:var(--navy); padding:30px 26px; transition:background 0.2s; cursor:default; position:relative; }
  ...
  .infra-card:hover { background:var(--navy-mid); }
...
.dream-letter { 
  ...
  @media(max-width:900px){
    ...
    .home-infra-grid,.ind-grid { grid-template-columns:1fr 1fr; }
    .cta-home-grid { grid-template-columns:1fr; }
    .hero-diagram-col { display:none; }
  }
...
<section class="problem-section" style="background:var(--navy-mid);border-bottom:1px solid var(--border);">
  <div class="container">
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:72px;align-items:start;">
      <div>
        ...
        <div style="font-family:'DM Serif Display',serif;font-size:19px;font-style:italic;color:var(--white);padding-left:18px;border-left:2px solid var(--gold);margin-bottom:12px;line-height:1.45;" class="reveal reveal-d3">"Technology alone does not solve this. Architecture does."</div>
        <div class="label reveal reveal-d3">Proven across multi-location environments in Kenya and Zambia.</div>
      </div>
